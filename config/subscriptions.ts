...
export const SUBSCRIPTION_PLANS: Record<'free' | 'pro', Plan> = {
  free: {
    id: 'free',
    name: 'Gratuito',
    description: 'Para quem está começando e quer criar seus primeiros moldes 2D.',
    prices: {
      monthly: {
        amount: 0,
        priceId: '',
    ...
    features: [
      ...
      { name: 'Exportação vetorial em PDF (com grid & gabarito)', included: false },
      { name: 'Lista de Materiais (BOM) em CSV', included: false },
      { name: 'Editor Ultra 3D (esculturas e voxels)', included: false },
      { name: 'Importação 3D (.VOX, .STL, .3MF, .OBJ, .GLB)', included: false },
      { name: 'Guia de montagem 3D passo a passo por camadas', included: false },
      { name: 'Projetos ilimitados', included: false },
    ],
  },
  pro: {
    id: 'pro',
    ...
    features: [
      ...
      { name: 'Exportação vetorial em PDF (com grid, réguas e gabarito)', included: true },
      { name: 'Lista de Materiais (BOM) em CSV e resumo de estoque', included: true },
