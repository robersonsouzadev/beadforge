...
import { LayoutGrid, Box, Trash2, Clock, Loader2, Globe } from 'lucide-react';
...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  const handleOpenPublish = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
        ...
        <div className="mt-4 pt-3 border-t border-zinc-800/60 flex items-center justify-between text-xs text-zinc-500">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1 text-zinc-500 hover:text-amber-400 transition rounded-md hover:bg-amber-400/10"
